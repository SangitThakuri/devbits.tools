...
export function JsonInput({ value, onChange, onFormat }: JsonInputProps) {
  return (
    <div className="flex flex-col gap-3">
      ...
      <button
        type="button"
        onClick={onFormat}
        className="self-start cursor-pointer rounded-lg bg-blue-600 px-5 py-2 text-sm font-medium text-white transition-colors hover:bg-blue-700"
      >
        Format JSON
      </button>
    </div>
